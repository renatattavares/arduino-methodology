...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% O processo de revisao do CBA 2020 sera DOUBLE BLIND, portanto NAO inclua
...
\begin{abstract}
  O processo de revisao do CBA 2020 sera DOUBLE BLIND, portanto NAO inclua autores na versão que será submetida para revisão. Leve isso em consideração ao citar seus próprios trabalhos.  \end{abstract}

\keywords{Template, Example.}

\selectlanguage{brazil}
\begin{abstract}
  O processo de revisao do CBA 2020 sera DOUBLE BLIND, portanto NAO inclua autores na versão que será submetida para revisão. Leve isso em consideração ao citar seus próprios trabalhos.
\end{abstract}
